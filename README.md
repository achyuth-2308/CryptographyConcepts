...
Welcome to my Cryptography Algorithms repository, built as part of our **CS3002 - Cryptography Concepts** course. This repository includes fully functional **C implementations** of 15 classic cryptographic algorithms across different categories — from simple monoalphabetic ciphers to complex transpositional systems.
